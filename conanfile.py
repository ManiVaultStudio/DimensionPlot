...
class DimensionPlotConan(ConanFile):
    ...
    name = "DimensionPlot"
    description = """Plugins for plotting feature data based on some metadata division"""
    topics = ("manivault", "plugin", "feature", "plot")
    url = "https://github.com/ManiVaultStudio/DimensionPlot"
    author = "julianthijssen@gmail.com"
    license = "LGPL 3.0"
    ...
    def _configure_cmake(self):
        cmake = CMake(self)
        cmake.configure(build_script_folder="hdps/DimensionPlot")
        cmake.verbose = True
        return cmake
